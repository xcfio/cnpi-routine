...
export default function CreditsPage() {
    return (
        <>
            <head>
                <title>Credits - CNPI Routine</title>
                        ...
                        <div className="credits-content">
                            ...
                            <div className="section">
                                ...
                                <div className="thanks-card">
                                    <p>
                                        We extend our heartfelt gratitude to all the individuals and organizations who
                                        have contributed to making this project possible. Your support, feedback, and
                                    ...
                                    <div className="contributors-list">
                                        ...
                                        <div className="contributor-simple">
                                            ...
                                            <span className="contributor-dash">-</span>
                                            <span className="contributor-work">
                                                Helped with beta testing and feedback
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="section">
                                ...
                                <div className="license-card">
                                    <div className="license-info">
                                        ...
                                        <p>
                                            This project is open source and available under the MIT License. You are
                                            free to use, modify, and distribute this software in accordance with the
                                            license terms.
                                        </p>
                                    </div>
                                </div>
